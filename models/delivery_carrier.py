...
class DeliveryCarrier(models.Model):
    ...
    def _get_gps_delivery_settings(self):
        """
        Get GPS delivery configuration settings from environment variables.
        ...
        return {
            ...
            'max_distance': float(os.environ.get(
                'DELIVERY_GPS_CARRIER_MAX_DISTANCE',
                DEFAULT_MAX_DISTANCE_MILES
            )),
            'max_quantity': int(os.environ.get(
                'DELIVERY_MAX_ORDER_QUANTITY',
